...
{	
	...
	HostServer = "http://vip-zhurche.tk/dee1ebcd105d3d47adf43aba6fd674e80d1dc35f/data-expired.php?e="+strSerial2;
...
{ 
	...
	{	
		...
		{
			MessageBox(0, "HDSN PC Anda telah expired!", "[D]-[S] 404", MB_OK | MB_ICONERROR);
			ExitProcess(0);
		}
		if(IsVerify)
		{
		...
		{
			MessageBox(0, "HDSN Anda belum terdaftar!", "[D]-[S] 404", MB_OK | MB_ICONERROR);
			ExitProcess(0);
		}
	}
}
