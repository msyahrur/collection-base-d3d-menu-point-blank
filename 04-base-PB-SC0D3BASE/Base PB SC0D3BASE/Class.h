...
public:
	...
	{
                       DWORD Resultg_pGameContext = 0xE4847C;//E4647C
                               DWORD ResultCallg_pGameContext = 0x4BF950;
		DWORD Callerg_pGameContext;
		__asm
		{
			mov ecx,Resultg_pGameContext
				call ResultCallg_pGameContext
				mov Callerg_pGameContext,eax;
		}
...
public:
	...
	void NET_Fire(D3DXVECTOR3* a1, D3DXVECTOR3* a2)
	{
		...
		tNET_Fire NET_Fire = (tNET_Fire)(0x656130);
...
public:
	...
	void setInvicibleTime(float invicibleTime)
	{
		...
		tWriteData WriteData = (tWriteData)(AddyEngine->GetAddyValueByKey(/*GameCharaBase.Function.writeData*/XorStr<0x1c,33,0x57F1B0>("\x5b\x7c\x73\x7a\x63\x49\x43\x51\x45\x67\x47\x54\x4d\x07\x6c\x5e\x42\x4e\x5a\x46\x5f\x5f\x1c\x44\x46\x5c\x42\x52\x7c\x58\x4e\x5a"+0x57F1B0).s));
		WriteData((DWORD)this + AddyEngine->GetAddyValueByKey(/*GameCharaBase.Pointer.invicibleTime*/XorStr<0x5C0,36,0x1AFE3E88>("\x65\x42\x49\x40\x65\x4F\x49\x5B\x4B\x69\x4D\x5E\x4B\x01\x60\x5E\x5B\x5D\x40\x50\x44\x19\x51\x57\x4C\x52\x5F\x54\x5C\x53\x25\x15\x2B\x2E\x21"+0x1AFE3E88).s), invicibleTime);
	}
