...
//EliteWorldCyber = new xEliteWorldCyber;
//EliteWorldCyber->AddAddyByPattern("XEWCPB.Import.i3CollideeLine::SetEnd", ADDY_GET_VALUE, 15, 4,"PointBlank.exe","8B 4D 0C 51 8B 4D F4 81 C1 ?? ?? ?? ?? FF 15 ?? ?? ?? ??");
//EliteWorldCyber->AddAddyByPattern("XEWCPB.Import.i3AiContext::getLocalTime", ADDY_GET_VALUE, 5, 4, "PointBlank.exe", "8B 4D 08 FF 15 ?? ?? ?? ?? 8B 45 FC 50 8B 4D F0");
//EliteWorldCyber->AddAddyByPattern("XEWCPB.Import.i3RenderContext::EndRender", ADDY_GET_VALUE, 2, 4, "i3FrameWorkDx.dll", "FF 15 ?? ?? ?? ?? 8B 4E 18 FF 15 ?? ?? ?? ?? 85 C0");	
//EliteWorldCyber->AddAddyByPattern("XEWCPB.Import.i3RenderContext::DrawIndexedPrim", ADDY_GET_VALUE, 7, 4,"i3SceneDx.dll","50 51 52 8B CF FF 15 ?? ?? ?? ?? 8B 4C 24");	
...
MakePTR((PBYTE)(DWORD)GetModuleHandleA("i3FrameWorkDx.dll")+ResultImport_i3RenderContext_EndRender-dwi3FrameworkDx,(DWORD)hkEndRender);
}
...
//#define OFS_SetRoom 		(ResultPTRTeam + 0x1D41F) // 0x47673
//#define OFS_SetRoom 		(ResultReplaceAllMode) // 0x47673
#define WEAPSIZE			0x158

//--- ResultLanternGranade ---//
#define ResultGranadeNULL 904007000
#define ResultK400Granade 904007001
#define ResultSmoke      904007002
#define ResultFlashBang    904007003
#define ResultWPSmoke 904007005
#define ResultWPSmokeD    904007007
#define ResultSmokePlus 904007010
#define ResultMedicalKit   904007011
#define ResultWPSmokePlus   904007012
#define ResultHelloweenKit 904007014
#define ResultChocholateKit 904007015
#define ResultC5EV 904007016
#define ResultWPSmoked 904007017
#define ResultK413G 904007018
#define ResultKetupatGranade 904007019
#define ResultCandyGranade 904007020
#define ResultMedicalKitLotus 904007021
#define ResultLanternGranade 904007022
#define ResultBreadGranade 904007023
#define ResultA 904007024
#define ResultB 904007025
#define ResultDecoyGranade 904007026
#define ResultD 904007027
#define ResultE 904007028
#define ResultF 904007029
#define ResultG 904007030
#define ResultH 904007031
#define ResultI 904007032
#define ResultSoccerGranade 904007033
#define ResultJ 904007034
#define ResultK 904007035
//--- Primary ---//
#define ResultRPGBazoka	   100016002
#define ResultFamasLC	   100003052
#define ResultK200Exit     100003011
#define ResultAK47D        100003058
#define ResultAK47Red	   100003068
//--- Scondary ---//
#define ResultM79		   0x23D2902C
#define ResultHK69		   0x23D2902A

#define SizeResultPangkat1                              0x9
#define SizeResultPangkat2                              0x11
#define SizeResultPangkat3                              0x12
#define SizeResultPangkat4                              0x13
#define SizeResultPangkat5                              0x14
#define SizeResultPangkat6                              0x15
#define SizeResultPangkat7                              0x16
#define SizeResultPangkat8                              0x17
#define SizeResultPangkat9                              0x18
#define SizeResultPangkat10                             0x19
#define SizeResultPangkat11                             0x21
#define SizeResultPangkat12                             0x22
#define SizeResultPangkat13                             0x23
#define SizeResultPangkat14                             0x24
#define SizeResultPangkat15                             0x25
#define SizeResultPangkat16                             0x26
#define SizeResultPangkat17                             0x27
#define SizeResultPangkat18                             0x28
#define SizeResultPangkat19                             0x29
#define SizeResultPangkat20                             0x31
#define SizeResultPangkat21                             0x32
#define SizeResultPangkat22                             0x33
#define SizeResultPangkat23                             0x34
#define SizeResultPangkat24                             0x35
#define SizeResultPangkat25                             0x36
#define SizeResultBlank                                 0xFF
//------------------------------------------------------------------------------//
//							Coded By Sadud Al Musadad							//
//							Date Create : 10 Sep 2015							//
//------------------------------------------------------------------------------//
