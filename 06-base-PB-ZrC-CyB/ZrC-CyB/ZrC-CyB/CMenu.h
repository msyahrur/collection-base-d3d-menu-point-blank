...
//-----------------------------------------------------------------------------
	enum COLORS{  // Normal Colors
		...
		BLACK2	=	D3DCOLOR_ARGB(200,0,0,0),
...
//-----------------------------------------------------------------------------
	enum I_COLORS{  // Item Colors
		...
		C_CAT	 =	D3DCOLOR_ARGB(255, 245, 000, 000),
...
//-----------------------------------------------------------------------------
	enum BK_COLORS{ // BackGround Colors
		...
		C_BOX2   = D3DCOLOR_ARGB(125, 000, 255, 255),
...
//-----------------------------------------------------------------------------
	...
	void	DrawBox_C( int x, int y, int w, int h, D3DCOLOR Color,LPDIRECT3DDEVICE9 pDevice);
