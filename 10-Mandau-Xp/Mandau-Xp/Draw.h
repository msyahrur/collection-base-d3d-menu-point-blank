...
void DrawPlayerBone(int Index, float Health, LPDIRECT3DDEVICE9 pDevice)
{
	...
	DrawBone(Index,7,6,Color);
	DrawBone(Index,6,5,Color);
	DrawBone(Index,5,4,Color);
	DrawBone(Index,4,2,Color);
	DrawBone(Index,2,0,Color);
	DrawBone(Index,6,11,Color);
	DrawBone(Index,6,10,Color);
	DrawBone(Index,0,13,Color);
	DrawBone(Index,0,12,Color);
	DrawBone(Index,13,15,Color);
	DrawBone(Index,12,14,Color);
	DrawBone(Index,15,9,Color);
	DrawBone(Index,14,8,Color);
}
