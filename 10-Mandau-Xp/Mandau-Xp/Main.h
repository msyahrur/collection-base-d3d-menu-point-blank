...
HRESULT WINAPI hkEndScene(LPDIRECT3DDEVICE9 pDevice)
{
	...
	//DrawString(20, 7, RainbowTextTest/*RainbowTextTest*/, "Cheat Point Blank Garena ID Version SDK 3.1 | ");
	...
	if(IsKeyPressed(VK_F6, 0)&1){GameHack.Player.Reborn=!GameHack.Player.Reborn;}
