...
void DoSpamChat(){
	...
	{
		pGameContext->setEvent(0x1FD, "VIP PRABAYAR 2018 ", NULL, NULL, NULL, NULL);
		pGameContext->setEvent(0x1FD, "Order Cheat VIP Anti Baned 100%", NULL, NULL, NULL, NULL);
		pGameContext->setEvent(0x1FD, "JIKA ANDA BERMINAT SILAHKAN Chat Kontak FB Saya >>DANI Xct", NULL, NULL, NULL, NULL);
