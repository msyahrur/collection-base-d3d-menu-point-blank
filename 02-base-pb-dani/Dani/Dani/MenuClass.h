...
int my = 20;
int	mx = 25;
char Header [88] = "      -:::[VIP]*|XMINANG-REBORN|:::-";
...
{
    //DrawTransparentBox(mx-10, my-4, Mxofs+52, 20, D3DCOLOR_ARGB(150, 000, 000, 000), pDevice);
	//DrawBorder(mx-10, my-4, Mxofs+35, 20, 1, D3DCOLOR_ARGB(255, 255, 000, 000), pDevice);
	//DrawTransparentBox(mx-10, my+20, Mxofs+52,(Mmax*17)+1, D3DCOLOR_ARGB(150, 000, 000, 000), pDevice);
	//DrawBorder(mx-10, my+20, Mxofs+35, (Mmax*17)+5, 1, D3DCOLOR_ARGB(255, 255, 000, 000), pDevice);
}
...
void MenuShow(float x, float y, LPDIRECT3DDEVICE9 pDevice)
{
	...
	if (Header[0]) 
	{	
		pFont->DrawText(NULL,Header,-1,&rect,DT_NOCLIP | DT_CENTER, D3DCOLOR_ARGB(255, 255, 125, 000));
		y+=Mysize+1;
	}
	for (i=0; i<Mmax; i++) 
	{
		...
		color=(val)?D3DCOLOR_ARGB(255, 255, 125, 000):D3DCOLOR_ARGB(255, 255, 255, 255);
