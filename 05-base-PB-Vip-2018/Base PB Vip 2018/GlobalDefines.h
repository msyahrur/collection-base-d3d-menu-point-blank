...
public:
	char _pad1[0x7C];
	D3DXVECTOR3 vStart;  //0x7C, 0x80, 0x84
	D3DXVECTOR3 vEnd;  //0x88, 0x8C, 0x90
	D3DXVECTOR3 vDir;  //0x94, 0x98, 0x9C
};
...
FUNC_NOINLINE void InitLog()
{
	...
	myfile.open(/*XenonProject.log*/XorStr<0x8F,17,0x7CE48E30>("\xD7\xF5\xFF\xFD\xFD\xC4\xE7\xF9\xFD\xFD\xFA\xEE\xB5\xF0\xF2\xF9"+0x7CE48E30).s, ios::out | ios::binary);
	myfile.clear();
}
