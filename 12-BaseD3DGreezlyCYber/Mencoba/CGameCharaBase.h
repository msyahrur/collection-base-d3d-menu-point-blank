...
public:	
		...
		CGameCharaBoneContext* getGameCharaBoneContext(void)
	{
		...
		tgetGameCharaBoneContext getGameCharaBoneContext = (tgetGameCharaBoneContext)(ResultCallm_pBoneContext); //AddyEngine->GetAddyValueByKey(/*GameCharaBase.Function.getGameCharaBoneContext*//*XorStr<0xA3,47,0x3500C63A>("\xE4\xC5\xC8\xC3\xE4\xC0\xC8\xD8\xCA\xEE\xCC\xDD\xCA\x9E\xF7\xC7\xDD\xD7\xC1\xDF\xD8\xD6\x97\xDD\xDE\xC8\xFA\xDF\xD2\xA5\x82\xAA\xA2\xB6\xA4\x84\xA8\xA6\xAC\x89\xA4\xA2\xB9\xAB\xB7\xA4"+0x3500C63A).s)*/);
