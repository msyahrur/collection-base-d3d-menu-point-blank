...
Current = 1;
pMenu.AddTab("Visual Hack"	,67  , 45, MenuX_TAB, 1,pDevice); 
pMenu.AddTab("ESP Hack"		,156 , 45, MenuX_TAB, 2, pDevice);
pMenu.AddTab("AIM Hack"		,245 , 45, MenuX_TAB, 3, pDevice);
pMenu.AddTab("Weapon Hack"	,334 , 45, MenuX_TAB, 4, pDevice);
...
//--------------------------------------------------------------------------//
if(MenuX_TAB == 5){
pMenu.AddCheck("Menu Keyboard"	, SwiftONOF		,MenuX_sShow	,1	,pDevice);
pMenu.AddText ("Tanggal"		, GetDate()	    ,pDevice);
pMenu.AddText ("Waktu"			, GetTime()	    ,pDevice);
pMenu.AddText ("FrameRate"		, ShowFPS()	    ,pDevice);
pMenu.AddText ("D3D Menu"		, "Menu Mouse"	,pDevice);
pMenu.AddText ("Abaut MenuX"	, "M. Ramadhan"	,pDevice);	
}}
//--------------------------------------------------------------------------//
